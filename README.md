...
Welcome to the old Flathub package for [SLADE](https://slade.mancubus.net/).

## Sunsetting

This application is sunset, for two reasons:

- There is no Flathub maintainer anymore.
  Simply put, nobody is willing to invest their time. Idem for GZDoom, which is bundled with this version of SLADE but which is now also unmaintained.
